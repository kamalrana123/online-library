...
if(strlen($_SESSION['adminform'])==0)
{
  ...
  if(isset($_GET['del']))
  {
    $id=$_GET['del'];
    echo"$id";
    $sql2="DELETE FROM bookiddetail WHERE bookiddetail.book_id=:id";
                ...
                <td>
                  ...
                  <td>
                    ...
                    <td>
                      ...
                      <a href="adminEditBook.php?bookId=<?php echo htmlentities($result1->book_id); ?>"><button class="edit">Edit</button></a>
                    </div>
                      <a href="adminmanagebook.php?del=<?php echo htmlentities($result1->book_id); ?>" onclick="return confirm('Are you sure you want to delete?');"><button class="delete">Delete</button></a>
                    </div>
                    </td>
              </tr>
            ...
            <td>
              ...
              <td>
                ...
                <td>
                  ...
                  <a href="adminEditBook.php?bookId=<?php echo htmlentities($result->book_id); ?>"><button class="edit">Edit</button></a>
                </div>
                  <a href="adminmanagebook.php?del=<?php echo htmlentities($result->book_id); ?>" onclick="return confirm('Are you sure you want to delete?');"><button class="delete">Delete</button></a>
                </div>
                </td>
          </tr>
